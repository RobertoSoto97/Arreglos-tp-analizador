...
public class MatchProcessor {
	 ...
	 * mientras que "lexems_table" almacena todo.  
	 */
    ...
    /* Agregado* Lista que almacena todos los Lexemas y Tokens */ 
    ...
    public void process_match(String token_value, String lexema) {
        ...
        switch (token_value) {
            case "CONST_INT":
                ...
                else{					//Symbol(String order, String name, String token, String type, String value, String size)
